function(build_rocksdb)
  ...
  list(APPEND rocksdb_INTERFACE_LINK_LIBRARIES QatDrv::usdm_drv_s)
  list(APPEND rocksdb_CMAKE_ARGS -DROCKSDB_PLUGINS=iaa_compressor)
  list(APPEND rocksdb_CMAKE_ARGS -DQPL_PATH=/root/intel-qpl/out)
  list(APPEND rocksdb_INTERFACE_LINK_LIBRARIES -L/root/intel-qpl/out/lib -L/root/intel-qpl/third-party/QAT/build -lqpl -lusdm_drv)
