...
class Pipe : public rgw::sal::DataProcessor {
 ...
 public:
  ...
  int process(bufferlist&& data, uint64_t offset, optional_yield y=null_yield) override {
...
class StripeProcessor : public Pipe {
 ...
 public:
  ...
  int process(bufferlist&& data, uint64_t data_offset, optional_yield y=null_yield) override;
};
